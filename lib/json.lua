...
function public.removeWhite(str)
...
function public.encode(val)
	return encodeCommon(val, false, 0, {})
end

function public.encodePretty(val)
...
function public.parseNumber(str)
	local i = 1
...
function public.parseString(str)
	str = str:sub(2)
	local s = ""
...
function public.decodeFromFile(path)
